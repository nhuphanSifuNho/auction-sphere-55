...
export const mockItems: Item[] = [
  { id: "i1", title: "Apple MacBook Pro 16\" M3 Pro", description: "Like new condition, purchased 3 months ago. Comes with original box and charger. 36GB RAM, 1TB SSD.", categoryId: "c1", condition: "USED", startingPrice: 450.00, reservePrice: 1800.00, sellerId: "u2", images: [] },
  { id: "i2", title: "1967 Gibson Les Paul Standard", description: "Authentic vintage guitar, original hardware, incredible tone. A true collector's piece.", categoryId: "c2", condition: "USED", startingPrice: 2000.00, reservePrice: 8000.00, sellerId: "u2", images: [] },
  { id: "i3", title: "Rolex Submariner 2022", description: "Unworn, full kit including box and papers. Reference 126610LN.", categoryId: "c4", condition: "NEW", startingPrice: 8000.00, reservePrice: 10000.00, sellerId: "u1", images: [] },
  { id: "i4", title: "Sony PlayStation 5 Bundle", description: "Console + 3 games (Spider-Man 2, God of War, Horizon), original receipt included.", categoryId: "c1", condition: "USED", startingPrice: 200.00, reservePrice: null, sellerId: "u2", images: [] },
  { id: "i5", title: "Abstract Oil Painting \"Serenity\"", description: "Original artwork by emerging artist. 48x36 inches, stretched canvas.", categoryId: "c3", condition: "NEW", startingPrice: 150.00, reservePrice: 400.00, sellerId: "u1", images: [] },
  { id: "i6", title: "Vintage Air Jordan 1 Chicago 1985", description: "Original 1985 pair, worn but in excellent condition. Size 10.", categoryId: "c4", condition: "USED", startingPrice: 3000.00, reservePrice: 5000.00, sellerId: "u5", images: [] },
  { id: "i7", title: "Canon EOS R5 Camera Body", description: "Professional mirrorless camera, low shutter count, mint condition.", categoryId: "c1", condition: "USED", startingPrice: 1500.00, reservePrice: 2500.00, sellerId: "u5", images: [] },
  { id: "i8", title: "Signed Michael Jordan Jersey", description: "Authenticated signed Bulls #23 jersey with COA from PSA.", categoryId: "c5", condition: "NEW", startingPrice: 500.00, reservePrice: 2000.00, sellerId: "u1", images: [] },
  { id: "i9", title: "Tesla Model S Wheel Set", description: "Set of 4 OEM 21\" wheels with tires, excellent tread remaining.", categoryId: "c6", condition: "USED", startingPrice: 800.00, reservePrice: 1500.00, sellerId: "u2", images: [] },
  { id: "i10", title: "Banksy Print \"Girl with Balloon\"", description: "Authenticated limited edition print, #45/500, framed.", categoryId: "c3", condition: "NEW", startingPrice: 1200.00, reservePrice: 3000.00, sellerId: "u5", images: [] },
  { id: "i11", title: "DJI Mavic 3 Pro Drone", description: "Fly more combo, barely used, all original accessories.", categoryId: "c1", condition: "USED", startingPrice: 800.00, reservePrice: 1400.00, sellerId: "u1", images: [] },
  { id: "i12", title: "Herman Miller Aeron Chair", description: "Size B, fully loaded, remastered edition. Perfect for home office.", categoryId: "c2", condition: "REFURBISHED", startingPrice: 400.00, reservePrice: 800.00, sellerId: "u2", images: [] },
  { id: "i13", title: "Vintage Leica M6 Film Camera", description: "Classic 35mm rangefinder, CLA'd recently, excellent optics.", categoryId: "c2", condition: "USED", startingPrice: 1800.00, reservePrice: 3000.00, sellerId: "u5", images: [] },
  { id: "i14", title: "Nike Dunk Low Panda", description: "Brand new, DS, size 9.5. Comes with original box.", categoryId: "c4", condition: "NEW", startingPrice: 100.00, reservePrice: null, sellerId: "u1", images: [] },
  { id: "i15", title: "Bose QuietComfort Ultra Headphones", description: "Open box, tested once. Full warranty remaining.", categoryId: "c1", condition: "REFURBISHED", startingPrice: 200.00, reservePrice: 300.00, sellerId: "u2", images: [] },
  { id: "i16", title: "Peloton Bike+ with Accessories", description: "Includes bike, mat, weights, shoes. Low miles, pristine.", categoryId: "c5", condition: "USED", startingPrice: 600.00, reservePrice: 1200.00, sellerId: "u5", images: [] },
];
